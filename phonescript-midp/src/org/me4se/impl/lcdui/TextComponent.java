...
public class TextComponent extends DeviceComponent {
	...
	public TextComponent(String type, boolean editable) {
		super(type, editable);
		lines.addElement("");
	}
	...
	public void doLayout() {
		...
		WordWrap ww = new WordWrap(getFontInfo().font, text, getWidth());
		int p0 = 0;
		cx = 0;
		cy = 0;
		while (true) {
	...
	public boolean keyPressed(int code, int mode) {
		...
		return super.keyPressed(code, mode);
	}
