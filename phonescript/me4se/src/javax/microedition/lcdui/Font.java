...
public class Font {
	...
	/**
	 * Gets the Font used by the high level user interface for the 
	 * fontSpecifier passed in. It should be used by subclasses of 
	 * CustomItem and Canvas to match user interface on the device.
	 * 
